...
class State:
    ...
    def update_from_json(self, data):
        with self.lock:
            ...
            self.ac_x = float(data.get("acX", 0))
            self.ac_y = float(data.get("acY", 0))
            self.ac_z = float(data.get("acZ", 0))
            self.gy_x = float(data.get("gyX", 0))
            self.gy_y = float(data.get("gyY", 0))
            self.gy_z = float(data.get("gyZ", 0))
            self.connected = True
